...
implementation. The migrated GitHub issue records a concrete failure mode: the
old migration dry-run had a parallel code path and printed hardcoded zeros. Per
the issue safety note, this work stays narrowly scoped to an enforceable
directive plus behavioral proof in current code.
