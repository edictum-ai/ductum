...
Before editing source files, verify the repair branch already contains the P3
stream head:
...
is missing. Do not continue on a branch that lacks `aa6c3697`. Do not create a
