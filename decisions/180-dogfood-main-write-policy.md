...
The imported issue body is brief and the private GitHub issue body was not
available from the unauthenticated API during this run, so the policy must stay
fail-closed and only rely on the imported problem statement.
